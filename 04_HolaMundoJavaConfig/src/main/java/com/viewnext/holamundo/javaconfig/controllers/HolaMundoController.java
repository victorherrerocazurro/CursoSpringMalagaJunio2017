...
public class HolaMundoController {
	...
	//http://localhost:8080/04_HolaMundoJavaConfig/holaMundo/Pepito
	//?nombre=Pepito&fechaNacimiento=2017/02/02&dni=11111111&id=12
	@RequestMapping(path="/{name2}",method=RequestMethod.GET)
	public View holaMundoPepito(
			Persona persona, Model model, 
			@RequestParam(value="id",required=false) int identificador, 
